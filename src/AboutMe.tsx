            ...
            <Box padding={1} margin={1} sx={{
                ...
                <Stack direction="row">
                    ...
                    <Container>
                        ...
                        <Spacer />
                        <Typography variant="h5" color="text.primary">A multi-disciplinary creative technologist focusing on immersive experiences in Canberra, Australia.</Typography>
                        <Spacer />
